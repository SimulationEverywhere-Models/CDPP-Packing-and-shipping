...
LDFLAGS += -L.
#^|
EXAMPLESOBJS=  Checkstock.o DeliveryType.o Packing.o RequestHandler.o Shipping.o register.o queue.o main.o generat.o cpu.o transduc.o distri.o com.o linpack.o debug.o trafico.o
#s
...
#^|
Checkstock.o: /cygdrive/C/eclipse/workspace/packingAndShipping/Checkstock.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${EXTRA_INCLUDES} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
DeliveryType.o: /cygdrive/C/eclipse/workspace/packingAndShipping/DeliveryType.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${EXTRA_INCLUDES} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
Packing.o: /cygdrive/C/eclipse/workspace/packingAndShipping/Packing.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${EXTRA_INCLUDES} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
RequestHandler.o: /cygdrive/C/eclipse/workspace/packingAndShipping/RequestHandler.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${EXTRA_INCLUDES} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
Shipping.o: /cygdrive/C/eclipse/workspace/packingAndShipping/Shipping.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${EXTRA_INCLUDES} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
register.o: /cygdrive/C/eclipse/workspace/packingAndShipping/register.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${EXTRA_INCLUDES} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
#
...
#^|
Checkstock.o: \
 /cygdrive/C/eclipse/workspace/packingAndShipping/Checkstock.cpp \
 /cygdrive/C/eclipse/workspace/packingAndShipping/Checkstock.h \
...
DeliveryType.o: \
 /cygdrive/C/eclipse/workspace/packingAndShipping/DeliveryType.cpp \
 /cygdrive/C/eclipse/workspace/packingAndShipping/DeliveryType.h \
 /cygdrive/C/eclipse/plugins/cdBuilder.simulator_1.0.0.201108272355/internal/atomic.h \
 /cygdrive/C/eclipse/plugins/cdBuilder.simulator_1.0.0.201108272355/internal/model.h \
 /cygdrive/C/eclipse/plugins/cdBuilder.simulator_1.0.0.201108272355/internal/port.h \
 /cygdrive/C/eclipse/plugins/cdBuilder.simulator_1.0.0.201108272355/internal/modelid.h \
 ...
 /cygdrive/C/eclipse/plugins/cdBuilder.simulator_1.0.0.201108272355/internal/ltranadm.h
Packing.o: \
 /cygdrive/C/eclipse/workspace/packingAndShipping/Packing.cpp \
 /cygdrive/C/eclipse/workspace/packingAndShipping/Packing.h \
 /cygdrive/C/eclipse/plugins/cdBuilder.simulator_1.0.0.201108272355/internal/atomic.h \
 /cygdrive/C/eclipse/plugins/cdBuilder.simulator_1.0.0.201108272355/internal/model.h \
 /cygdrive/C/eclipse/plugins/cdBuilder.simulator_1.0.0.201108272355/internal/port.h \
 /cygdrive/C/eclipse/plugins/cdBuilder.simulator_1.0.0.201108272355/internal/modelid.h \
 ...
 /cygdrive/C/eclipse/plugins/cdBuilder.simulator_1.0.0.201108272355/internal/ltranadm.h
RequestHandler.o: \
 /cygdrive/C/eclipse/workspace/packingAndShipping/RequestHandler.cpp \
 /cygdrive/C/eclipse/workspace/packingAndShipping/RequestHandler.h \
 /cygdrive/C/eclipse/plugins/cdBuilder.simulator_1.0.0.201108272355/internal/atomic.h \
 /cygdrive/C/eclipse/plugins/cdBuilder.simulator_1.0.0.201108272355/internal/model.h \
 /cygdrive/C/eclipse/plugins/cdBuilder.simulator_1.0.0.201108272355/internal/port.h \
 /cygdrive/C/eclipse/plugins/cdBuilder.simulator_1.0.0.201108272355/internal/modelid.h \
 ...
 /cygdrive/C/eclipse/plugins/cdBuilder.simulator_1.0.0.201108272355/internal/ltranadm.h
Shipping.o: \
 /cygdrive/C/eclipse/workspace/packingAndShipping/Shipping.cpp \
 /cygdrive/C/eclipse/workspace/packingAndShipping/Shipping.h \
 /cygdrive/C/eclipse/plugins/cdBuilder.simulator_1.0.0.201108272355/internal/atomic.h \
 /cygdrive/C/eclipse/plugins/cdBuilder.simulator_1.0.0.201108272355/internal/model.h \
 /cygdrive/C/eclipse/plugins/cdBuilder.simulator_1.0.0.201108272355/internal/port.h \
 /cygdrive/C/eclipse/plugins/cdBuilder.simulator_1.0.0.201108272355/internal/modelid.h \
 ...
 /cygdrive/C/eclipse/plugins/cdBuilder.simulator_1.0.0.201108272355/internal/ltranadm.h
register.o: \
 /cygdrive/C/eclipse/workspace/packingAndShipping/register.cpp \
